...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.Export"
COPYRIGHT = 'Copyright 2013 FubuMVC.Export. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  FileUtils.rm_rf 'src/ExportGridHarness/fubu-content'
  bottles("assembly-pak src/FubuMVC.Export")

  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.Export.sln', :clrversion => CLR_TOOLS_VERSION
